...
import { FireIcon, CurrencyDollarIcon, DocumentTextIcon } from '@heroicons/react/24/outline';

const PlatoForm = ({ formData, onChange }) => {
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        <label className={labelClass}>
                            Categoría (Tipo Plato) <span className="text-red-500">*</span>
                        </label>
                        ...
                        />
                         <p className="text-[10px] text-gray-400 mt-1 ml-1">
                            Selecciona la familia del plato (ej: Entradas, Fondos).
                        </p>
                    </div>
