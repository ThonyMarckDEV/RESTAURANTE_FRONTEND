...
const menus = {
    superadmin: [
        ...
        { section: 'Productos', icon: PillBottle, subs: [{ name: 'Agregar Producto', link: '/superadmin/agregar-producto-venta' }, { name: 'Listar Productos', link: '/superadmin/listar-productos-venta' }] },
        ...
        { section: 'Platos', icon: Soup, subs: [{ name: 'Agregar Plato', link: '/superadmin/agregar-plato' }, { name: 'Listar Platos', link: '/superadmin/listar-platos' }] },
    ...
    admin: [
        ...
        { section: 'Insumos', icon: BeefIcon, subs: [{ name: 'Listar Insumos', link: '/admin/listar-insumos' }] },
        ...
        { section: 'Productos', icon: PillBottle, subs: [{ name: 'Listar Productos', link: '/admin/listar-productos-venta' }] },
        { section: 'Platos', icon: Soup, subs: [{ name: 'Plato Sede', link: '/admin/gestionar-plato-sede' }] },
